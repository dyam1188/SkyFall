...
public class MainMenu : MonoBehaviour
{
    ...
    [SerializeField]
    Image[] menuText = new Image[5];

    [SerializeField]
    Canvas mainCanvas, howtoplayCanvas, optionsCanvas;

    HowToPlayMenu howtoplayMenu;
    OptionsMenu optionsMenu;

    const float fadeSpeed = 0.1f;  //the rate at which objects fade in or out per frame

    //text sizes
    Vector3 textSmall = new Vector3(1f, 1f, 1f);
    Vector3 textLarge = new Vector3(1.25f, 1.25f, 1f);
